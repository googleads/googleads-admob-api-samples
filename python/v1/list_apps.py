...
PUBLISHER_ID = 'pub-7319269804560504'
  ...
  while True:
    ...
    for app in apps:
      ...
      if 'linkedAppInfo' in app:
        ...
        #linkedAppInfo['appStoreId'] if linked_app_info != null else ''
        #linkedAppInfo['displayName'] if linked_app_info != null else ''
      ...
      if 'manualAppInfo' in app:
        ...
        #app_manual_app_info['displayName'] if app_manual_app_info != null else ""
...
def main():
  service = admob_utils.authenticate('v1beta')
